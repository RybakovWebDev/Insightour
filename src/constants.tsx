...
export const ICONS_UNIVERSITIES = {
  Caucasus: { src: "/images/universities/cu_logo.webp", alt: "Logo of the Caucasus University" },
  European: { src: "/images/universities/eu_logo.webp", alt: "Logo of the European University" },
  Ilia: { src: "/images/universities/ilia_logo.webp", alt: "Logo of the Ilia University" },
  NewVision: { src: "/images/universities/nv_logo.webp", alt: "Logo of the New Vision University" },
  Tsmu: { src: "/images/universities/tsmu_logo.webp", alt: "Logo of the Tbilisi State Medical University" },
  Georgia: { src: "/images/universities/ug_logo.webp", alt: "Logo of the University of Georgia" },
};
